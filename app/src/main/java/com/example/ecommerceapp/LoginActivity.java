    ...
    private void AllowAccessToAccount(final String phone, final String password)
    {
        ...
        RootRef.addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot)
            {
                ...
                {
                    Toast.makeText(LoginActivity.this, "Account for this "+phone+ " number do not exist.", Toast.LENGTH_SHORT).show();
                    loadingBar.dismiss();
                    Toast.makeText(LoginActivity.this, "you need to creat new Account.", Toast.LENGTH_SHORT).show();
                }
            }
